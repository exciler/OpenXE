  ...
  public function ActionList() {
    ...
    switch ($cmd) {
      ...
      case "selectoptions":
        ...
        $sql = "SELECT mo.gruppe, mo.id, mo.name FROM matrixprodukt_eigenschaftenoptionen mo WHERE mo.aktiv = 1 ORDER BY mo.name";
        $options = $this->app->DB->SelectArr($sql);
        return new JsonResponse(['groups' => $groups, 'options' => $options]);
    }
  ...
  public function ActionArticle() {
    ...
    switch ($cmd) {
      ...
      case "groupedit":
        ...
        if (!$groupId)
          return new JsonResponse(statusCode: 404);
