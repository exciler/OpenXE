...
"SELECT 
    ...
    $sqlpackages = "
        ...
        WHERE DATE(v.datum) = %s ".$this->app->erp->ProjektRechte('l.projekt');
    $this->app->Tpl->Set('PAKETE',$this->app->DB->Select(sprintf($sqlpackages, "CURDATE()")));
    ...
    $this->app->Tpl->Set('PAKETE',$this->app->DB->Select(sprintf($sqlpackages, "CURDATE()-1")));
